 ...
 * tagged-union `ResourceState<T>` from `@causlts/sync` becomes a
 ...
 * `@causlts/sync` — no fork. `SuspendableResource<T>` is kept as a
 * type alias for backward compatibility with consumers that imported
 * it from this package.
 */

import type { Graph } from '@causlts/core'
import { assertNever, type ReadOnlyGraph } from '@causlts/core/internal'
 ...
 * `@causlts/sync`. The previous shape was a structurally-incompatible
