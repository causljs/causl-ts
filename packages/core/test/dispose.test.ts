 ...
 * via `@causlts/core/internal`'s `dispose` helper. `_dispose` is
 * deliberately not part of the seven-method commitment, not in the
 * public README, and not covered by SemVer guarantees on the
 * `@causlts/core` public exports — it lives behind the
 * `@causlts/core/internal` entrypoint because disposal is an
 ...
 * guard.
 */
describe('@causlts/core/internal :: dispose(graph, node)', () => {
  /**
