 ...
 * canonical `@causlts/react` adapter usage.
 *
 * Issue #1241 surfaced that the H1 hazard warning (#1155, PR #1238)
 * fired on every commit when any `@causlts/react` hook was in use. The
...
describe('H1 hazard warning — @causlts/react adapter exemption (#1241)', () => {
