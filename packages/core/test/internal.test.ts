 ...
 *
 * Wiring tests for the `@causlts/core/internal` entrypoint. The
 ...
 * `@causlts/core` public exports — `_dispose` is the canonical
 ...
 */
describe('@causlts/core/internal entrypoint', () => {
  /**
  ...
  it('exports the INTERNAL_ENTRYPOINT marker', () => {
    ...
    expect(INTERNAL_ENTRYPOINT).toBe('@causlts/core/internal')
  })
