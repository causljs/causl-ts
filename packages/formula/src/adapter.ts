 ...
 *
 * Formula-to-derived-node adapter for `@causlts/formula`. Causl
 ...
 * the responsibility of the `@causlts/core` graph; this module merely
...
import type { Compute, DerivedNode, Graph, Node } from '@causlts/core'
