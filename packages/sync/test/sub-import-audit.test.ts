 ...
 * (`@causlts/sync/resource`, `@causlts/sync/conflict`) and asserts they
...
describe('SPEC.async §14.2 — bundle audit', () => {
  it('@causlts/sync/resource re-exports the resource primitive', () => {
  ...
  it('@causlts/sync/conflict re-exports the conflict primitive', () => {
