 ...
 *
 * Smoke test for the `@causlts/react` package scaffold. Confirms the
...
/**
 * Suite covering minimal scaffolding guarantees of `@causlts/react`.
 */
describe('@causlts/react scaffolding', () => {
  /**
