 ...
 *
 * Primary subscription hook for `@causlts/react`. {@link useCausl}
...
import { __causlAdapterRead, narrowCapability, type ReadOnlyGraph } from '@causlts/core/internal'
 ...
 * `@causlts/core/internal` (the type narrowing forbids it at compile
