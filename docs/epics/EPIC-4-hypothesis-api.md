...
```ts
import { hypothesis, afterCommit } from '@causlts/hypothesis'
...
```
packages/hypothesis/
├── package.json              # name: "@causlts/hypothesis", private: false, sideEffects: false
