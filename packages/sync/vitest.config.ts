 ...
 *
 * Vitest configuration for the `@causlts/sync` package. Aliases
 * `@causlts/core` and `@causlts/core/internal` directly to the
...
export default defineConfig({
  resolve: {
    ...
    alias: [
      ...
      // Route `@causlts/core` imports to in-tree source so changes in
