...
function makeSerdeJsonPlaceholder(): Bridge {
  const placeholderError = (): Error =>
    new Error(
      '[@causlts/core] serde-json bridge is a placeholder pending #693. ' +
 ...
 * implementation will dynamic-import `@causlts/core/wasm-gc-builtins`
 ...
 * @remarks
 * **STUB pending #692.** Returns the placeholder. The real
 * implementation will dynamic-import `@causlts/core/wasm-gc-classic`.
 */
 ...
 * implementation will dynamic-import `@causlts/core/wasm-serde` and
