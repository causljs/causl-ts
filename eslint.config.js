...
export default [
  ...
  // package boundary. `@causlts/core` is the engine substrate and
          ...
          patterns: [
            {
              group: [
                ...
                '@causl/bench',
                '@causl/bench/*',
                '@causlts/migration-check',
                '@causlts/migration-check/*',
              ],
              message:
                'SPEC §17.3 / §7: `@causlts/core` is the engine substrate and must not import from sibling adapter packages. Move the shared symbol into core or invert the dependency.',
            },
          ],
        },
      ],
  ...
  // ONLY through the documented `@causlts/core/internal` entrypoint.
  // Deeper paths (`@causlts/core/dist/...`, `@causlts/core/src/...`)
          ...
          patterns: [
            {
              ...
              message:
                'SPEC §12.3: adapters may reach engine internals only through the `@causlts/core/internal` seam — never through dist/ or src/ deep paths.',
            },
          ],
        },
      ],
