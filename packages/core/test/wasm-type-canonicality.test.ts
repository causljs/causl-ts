 ...
 *
 * Type-canonicality pinning suite for the `@causlts/core/wasm` entry
 * point (issue #1121).
 *
 * The `@causlts/core/wasm` subpath previously declared in-tree mirrors
 ...
 *      `@causlts/core/wasm`'s `StatechartInput` / `StatechartResult` /
...
describe('wasm type canonicality (issue #1121)', () => {
  it('StatechartInput from @causlts/core/wasm is the same type as from src/backend.js', () => {
  ...
  it('StatechartResult from @causlts/core/wasm is the same type as from src/backend.js', () => {
  ...
  it('ForbiddenStatechartTransition from @causlts/core/wasm is the same type as from src/backend.js', () => {
    const ok: AssertEq<
