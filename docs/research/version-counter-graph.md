...
| §11 whyUpdated / whyNotUpdated lineage | `@causlts/devtools-bridge` reads `computedAt` | Derives "this commit recomputed it / a prior commit produced it" by comparing `computedAt` to the commit window |
