 ...
 *
 * Pinning tests for the `@causlts/core/wasm` lazy-load entry point
 * (issue #684, evolved by #1065). Three contracts are exercised:
 *
 *   1. **Out-of-bundle.** Importing the main `@causlts/core` barrel
 *      must not pull `@causlts/core/wasm` into the loaded module
 ...
 */
describe('@causlts/core barrel does not pull in @causlts/core/wasm', () => {
  it('main bundle text contains no wasm-loader sentinels', async () => {
    ...
    // `loadWasmBackend()` from `@causlts/core/wasm`. Their presence in
...
describe('@causlts/core/wasm — loader skeleton', () => {
  afterEach(async () => {
