 ...
 * `process.env.NODE_ENV` literal gate (#1241 fix C). `@causlts/core`'s
 ...
 * NODE_ENV production gate across `@causlts/core`. `process.env` is
 ...
 *   every consumer that does not bundle `@causlts/core` through a prod
