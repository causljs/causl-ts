 ...
 *
 * Disposal goes through `@causlts/core/internal`'s `dispose` rather
 ...
 * behind the `@causlts/core/internal` entrypoint and is not covered
...
import { __causlAdapterRead, dispose } from '@causlts/core/internal'
 ...
 * node is disposed via `@causlts/core/internal`'s `dispose` when the
